...
namespace TeacherAttendance
{
    public partial class frmTeacherAttendance : Form
    {
        ...
        private void DGVAttendance_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
        ...
        private void DGVAttendance_DoubleClick(object sender, EventArgs e)
        {
            ...
            Attendance currentAtt = attendance.getAttendanceByIndex(DGVAttendance.CurrentRow.Index);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DGVAttendance.DataSource = update; 
            attendance.addAttendance(DTPickerdate.Value.ToString(),
